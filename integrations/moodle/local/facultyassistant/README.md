...
The service starts disabled intentionally. Version `0.3.0` adds separately controlled course-category creation to the existing question-bank publishing operation.
