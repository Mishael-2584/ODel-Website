...
export default function ApplicationPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    sub_location: '',
    village: '',
    language_instruction_secondary: '',
    mother_tongue: '',
    other_languages: '',
    semester_applying: '',
    ...
    teaching_subject1: '',
    teaching_subject2: '',
    found_out_about_ueab: [] as string[],
    found_out_details: '',
    has_rpl_qualifications: false,
    rpl_details: '',
    rpl_evaluation_method: [] as string[],
    rpl_mode_of_study: '',
    rpl_certificate_status: '',
    has_been_employed: false,
    previous_employers: '',
    special_needs_types: [] as string[],
    ...
    parent_sda_employed: false,
    parent_sda_employer_name: '',
    consent_provider: '',
    consent_name: '',
    consent_signature: '',
    consent_date: new Date().toISOString().split('T')[0],
    financial_responsibility_provider: '',
    financial_responsibility_name: '',
    financial_responsibility_signature: '',
    financial_responsibility_date: new Date().toISOString().split('T')[0],
    applicant_commitment_accepted: false,
    data_protection_consent_accepted: false,
    data_protection_consent_name: '',
    data_protection_consent_signature: '',
    data_protection_consent_date: new Date().toISOString().split('T')[0],
    is_minor: false,
    minor_consent_provider: '',
    minor_consent_name: '',
    minor_consent_signature: '',
    minor_consent_date: new Date().toISOString().split('T')[0],
    minor_data_protection_consent: false,
    payment_method: '',
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Progress Indicator */}
      <ProgressIndicator currentStep={step} applicationType={applicationType} />
